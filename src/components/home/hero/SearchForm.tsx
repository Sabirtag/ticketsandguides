  ...
  return <form onSubmit={handleBook} className="flex items-end gap-3">
      <div className="flex-1 relative">
        ...
        <div className="relative">
          ...
          <Input placeholder="Where to" value={searchQuery} onChange={e => setSearchQuery(e.target.value)} onFocus={() => setShowSuggestions(true)} className="w-full bg-white/90 text-gray-900 placeholder:text-gray-500 h-10 border-2 border-[#006d5b] focus:border-[#006d5b] rounded-md pl-9" />
        </div>
      ...
      <div className="w-[120px]">
        <Button type="submit" className="w-full h-10 bg-[#006d5b] hover:bg-[#006d5b]/90 text-white transition-transform hover:scale-95 active:scale-90">
          Book
        </Button>
      </div>
    </form>;
