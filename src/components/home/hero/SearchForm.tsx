  ...
  return <form onSubmit={handleBook} className="flex flex-col space-y-3 sm:space-y-0 sm:grid sm:grid-cols-2 md:grid-cols-5 sm:gap-3">
      <div className="md:col-span-1 relative">
        <div className="relative">
          ...
          <Input placeholder="Where to" value={searchQuery} onChange={e => setSearchQuery(e.target.value)} onFocus={() => setShowSuggestions(true)} className="bg-white rounded-lg px-[36px]" />
        </div>
