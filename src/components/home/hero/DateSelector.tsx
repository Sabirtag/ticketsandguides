      ...
      <Popover>
        <PopoverTrigger asChild>
          <Button 
            ...
            className={cn(
              "w-full bg-white/90 text-gray-900 placeholder:text-gray-500 h-9 sm:h-10 border-2 border-[#006d5b] focus:border-[#006d5b] pl-9 px-[11px] mx-0 text-base font-normal rounded py-0 text-left",
