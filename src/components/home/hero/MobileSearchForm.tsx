...
import { MapPin, Calendar, Users, Sparkles, Search, ArrowLeft } from "lucide-react";
      ...
      <form onSubmit={handleSearch} className="space-y-4">
        <div className="flex items-center gap-2 bg-white/90 rounded-md p-2 relative">
          ...
          <Sheet>
            ...
            <SheetContent side="bottom" className="h-[85vh]" hideCloseButton>
              <SheetHeader>
                <div className="flex items-center gap-2">
                  <SheetClose asChild>
                    <Button variant="ghost" size="icon" className="h-8 w-8 text-inherit bg-inherit">
