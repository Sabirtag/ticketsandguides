      ...
      <Popover open={showGuideOptions} onOpenChange={setShowGuideOptions}>
        ...
        <PopoverContent className="w-auto sm:w-80 bg-[#FDE1D3] border-0">
          <div className="space-y-2 p-2">
            {["choose_for_me", "choose_own", "no_guide"].map(choice => <Button key={choice} variant="ghost" onClick={() => handleGuideSelection(choice)} className="w-full justify-start text-xs bg-[#006d5b] font-normal text-white rounded-sm text-center sm:text-sm transition-none">
