    ...
    <form onSubmit={handleBook} className="flex items-end gap-3">
      <div className="flex-1 relative">
        <div className="relative">
          ...
          <Input 
            ...
            className="w-full bg-white/90 text-gray-900 placeholder:text-gray-500 h-10 border-2 border-primary focus:border-primary rounded-md pl-9" 
          />
        </div>
      ...
      <div className="w-[120px]">
        <Button 
          type="submit" 
          variant="cta"
          className="w-full h-10 text-white transition-transform hover:scale-95 active:scale-90"
        >
          Book
        </Button>
      </div>
