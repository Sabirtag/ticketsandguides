      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {visibleExperiences.map((exp) => (
            <div 
              key={exp.id} 
              className="relative rounded-xl overflow-hidden cursor-pointer hover:shadow-md transition-shadow aspect-[3/4] touch-manipulation group"
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent flex flex-col justify-end p-3 md:p-4">
                ...
                <p className="text-white/90 text-sm">{exp.duration}</p>
